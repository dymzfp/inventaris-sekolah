<?php  
  ...
  $id = $_POST['id'];
	...
	$stmt = $db->prepare("SELECT 
      ...
      d.nama_barang,
      e.nama_ruang
    FROM pinjam a LEFT JOIN inventaris b ON a.id_inventaris = b.id_inventaris LEFT JOIN peminjam c ON a.id_peminjam = c.id_peminjam LEFT JOIN barang d ON b.id_barang = d.id_barang LEFT JOIN ruang e ON b.id_ruang = e.id_ruang LEFT JOIN kelas f ON c.id_kelas = f.id_kelas WHERE a.id_peminjam = ". $id . " ORDER BY a.id_pinjam DESC");
