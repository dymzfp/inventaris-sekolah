...
$columns = array(
    ...
    array( 'db' => 'jumlah_pinjam', 'dt' => 2 ),
    array( 'db' => 'nama_peminjam',  'dt' => 3 ),
    array( 'db' => 'nama_kelas',   'dt' => 4 ),
    array( 'db' => 'nama_ruang', 'dt' => 5 ),
    array( 'db' => 'keterangan', 'dt' => 6 ),
    array( 'db' => 'tanggal_pinjam', 'dt' => 7, 'formatter' => function( $d, $row ) {

        $x = substr($d, 0, 10);
        return $x;

    }),
    array( 'db' => 'tanggal_kembali', 'dt' => 8 ),
    ...
    array( 'db' => 'status_pinjam', 'dt' => 10, 'formatter' => function( $d, $row ) {
                if ($d == 1) {
