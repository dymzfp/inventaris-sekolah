<?php  
	...
	$stmt = $db->prepare("SELECT 
      ...
      d.nama_barang,
      e.nama_ruang
    FROM pinjam a LEFT JOIN inventaris b ON a.id_inventaris = b.id_inventaris LEFT JOIN peminjam c ON a.id_peminjam = c.id_peminjam LEFT JOIN barang d ON b.id_barang = d.id_barang LEFT JOIN ruang e ON b.id_ruang = e.id_ruang LEFT JOIN kelas f ON c.id_kelas = f.id_kelas ORDER BY a.id_pinjam DESC");
    ...
    foreach ($data as $k) {
        ...
        <th><?php echo $k['nama_peminjam']; ?></th>
        ...
        <th><?php if ($k['status_pinjam'] == 1) {
                  echo '<a href="#" data-id="'.$k['id_pinjam'].'" class="kofir-kembali"><span class="label label-inverse"><i class="fa fa-edit"></i> Konfirmasi</span></a>';
                }
                ?></th>
